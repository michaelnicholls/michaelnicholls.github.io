		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#michaelbackground-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"michaelbackground-display": {
								"semanticObject": "michaelbackground",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=michael.background",
									"url": sap.ui.require.toUrl("michael/background")
								}
							}
						}
					}
